...
function Orders() {
  ...
  useEffect(() => {
    // Always fetch orders since PrivateRoute already ensures we're logged in
    setIsLoading(true);
    
    // Use "current" as the default userId to let the backend use the authenticated user
    const userId = userData?.user_id || "current";
    
    apiInstance.get(`customer/orders/${userId}/`)
      .then((res) => {
        setOrders(res.data);
      ...
      <div className="row">
        ...
        <main className="col-lg-9 col-xl-10 ms-sm-auto px-4 py-3">
          <div className="container-fluid">
            ...
            {/* Only show summary cards and order content if logged in, not loading, and have orders */}
